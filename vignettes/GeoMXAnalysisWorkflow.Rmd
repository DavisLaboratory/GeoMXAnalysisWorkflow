...
A typical vissE plot is including a word-cloud plot, a network plot and a gene statistical plot. The word-cloud plot is showing the selected gene sets clusters (top 9 in this case, order by cluster size), with their most common key words; the network plot is visualise the gene sets as a network (nodes are gene sets and the edges are the commoness between the gene sets); gene statistic plots are showing the logFC of the genes in the corresponding clusters.
