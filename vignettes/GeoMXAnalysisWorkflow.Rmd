...
After getting the files from `ExperimentHub`, we can have a first look at the format and content of the three files, they are the usual files we can obtain from Nanostring.
